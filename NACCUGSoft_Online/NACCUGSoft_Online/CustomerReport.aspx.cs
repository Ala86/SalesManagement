    ...
    public partial class CustomerReport : System.Web.UI.Page
    {
        ...
        private void getEntityCode()
        {
            if (datefrom.Text != string.Empty && dateto.Text != string.Empty)
            {
                ...
                rprt.Load(Server.MapPath("~/CryCustomerDetails.rpt"));
                rprt.FileName = Server.MapPath("~/CryCustomerDetails.rpt");
                SqlCommand cmd = new SqlCommand();
                cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "SPRepCustomerDetails";
                ...
                sda.Fill(ds, "SPRepCustomerDetails");
