<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineVisaRequest.aspx.cs" Inherits="NACCUGSoft_Online.OnlineVisaRequest" %>
...
<body>
   ...
   <div id='container' style='width: 100%;'>
        ...
        <asp:Label ID="Label1" runat="server" CssClass="auto-style1" Font-Bold="True" Font-Size="Larger" Text="Statement Request Form"></asp:Label>
        ...
        <asp:Panel ID="Panel1" runat="server" CssClass="auto-style2">
            ...
            <asp:Label ID="Label9" runat="server" CssClass="auto-style18" Text="Purpose"></asp:Label>
            ...
            <asp:Label ID="Label10" runat="server" CssClass="auto-style21" Text="Address To"></asp:Label>
            <asp:Button ID="Button1" runat="server" CssClass="auto-style23" Text="Save" OnClick="Button1_Click" />
            <asp:TextBox ID="TextBox7" runat="server" CssClass="auto-style25" TextMode="MultiLine" BackColor="Yellow"></asp:TextBox>
        </asp:Panel>
        <asp:Label ID="Label11" runat="server" CssClass="auto-style24" Font-Bold="True" Text="Note: Your request will take a maximum of two (2) working days."></asp:Label>
        <asp:TextBox ID="TextBox8" runat="server" CssClass="auto-style26" Enabled="False"></asp:TextBox>
        <asp:Label ID="Label12" runat="server" CssClass="auto-style27" Text="Member Code"></asp:Label>
        <asp:Button ID="Button2" runat="server" CssClass="auto-style28" PostBackUrl="~/MainMenu.aspx" Text="Return to Mainmenu" />
          </div>
    </form>
</body>
</html>
