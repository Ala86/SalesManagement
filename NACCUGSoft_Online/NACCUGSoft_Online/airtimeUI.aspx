<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="airtimeUI.aspx.cs" Inherits="NACCUGSoft_Online.airtimeUI" %>
        ...
        <asp:Panel ID="Panel1" runat="server" align="center" Width="40%" Height="60%" BackColor="#CCFFFF" BorderColor="#333300" BorderStyle="Groove" CssClass="active right">
          <br>
            ...
            <p>
               ...
               <%-- <asp:DropDownList ID="GSMType" runat="server" Height="30px" Width="250px" BackColor="#FFFF66">
                    <asp:ListItem Value="africell">Africell</asp:ListItem>
                    <asp:ListItem Value="qcell">Qcell</asp:ListItem>
                    <asp:ListItem Value="gamcel">GAMCELL</asp:ListItem>
                    <asp:ListItem Value="comium">Comium</asp:ListItem>
                                </asp:DropDownList>--%>
                </label>
                </p>
           ...
           <p>
            ...
            <p>
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Save" Height="30px" Width="250px" BackColor="#FFFF66"/> </p>
            <p>
