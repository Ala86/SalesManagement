<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductReport.aspx.cs" Inherits="NACCUGSoft_Online.ProductReport" %>
...
<%--                <li><a href="InvoiceForm.aspx">Home</a> </li>
    ...
    <form id="form1" runat="server">
            <asp:Panel ID="pnlPopup" runat="server" align="center" Width="60%" Height="50%" BackColor="#CCFFFF" BorderColor="#333300" BorderStyle="Groove" CssClass="active right">
