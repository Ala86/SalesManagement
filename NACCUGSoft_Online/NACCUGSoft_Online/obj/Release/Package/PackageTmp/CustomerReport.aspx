<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerReport.aspx.cs" Inherits="NACCUGSoft_Online.CustomerReport" %>
...
<%--                <li><a href="InvoiceForm.aspx">Home</a> </li>
    ...
    <form id="form1" runat="server">
        ...
        <h2 class="auto-style2"><strong>Customer Report</strong></h2>
        <div id="container">
            ...
            <p>
                 <label>
                    Date From<br>
                     <asp:TextBox type="date" ID="datefrom" runat="server" Height="25px" Width="200px"></asp:TextBox>
