        ...
        <div id="container">
            <p>
                ...
                <label>
                 ...
                 <label>
                    Phone Number <br>
                    <input type="text" id ="phonenumber" name ="phonenumber" placeholder="Eg +220 7996 556">
                </label>
            </p>
            <p>
                <label>
                    Employment Number<br>
                <input type="text" id ="enumber" name ="enumber" placeholder="Placeholder" value="021">
                </label>
                <label>
                    Middle Name<br>
            ...
            <p>
                <label style="visibility:hidden">
                    number<br>
                    <input type="number" id ="number" name ="number" placeholder="123456789">
                </label>
                                <label>
                    Last Name<br>
