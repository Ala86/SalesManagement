<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ReceiptListing.aspx.cs" Inherits="NACCUGSoft_Online.ReceiptListing" %>
...
<%--                <li><a href="InvoiceForm.aspx">Home</a> </li>
    ...
    <form id="form1" runat="server">
          <h2>Posting Form</h2>
        <p>
            <asp:Button ID="Button2" runat="server" Text="Make Posting" Width="200px" Height="40" BackColor="Blue" ForeColor="White" PostBackUrl="~/payment.aspx"/>
        </p>
        <br>
        <p>
...
<%--              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="ObjectDataSource1" Height="40px" AllowPaging="True">
              ...
              <asp:GridView ID="GridView2" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Width="1500px" Height="40px" AllowPaging="True"  OnPageIndexChanging="OnPageIndexChanging" PageSize="10">
                  <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                  <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
                  <PagerStyle ForeColor="#8C4510" HorizontalAlign="Center" />
                  <RowStyle BackColor="#FFF7E7" ForeColor="#8C4510" />
