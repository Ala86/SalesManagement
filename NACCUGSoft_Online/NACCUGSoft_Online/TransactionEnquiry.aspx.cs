...
{
    public partial class TransactionEnquiry : System.Web.UI.Page
    {
      ...
      //  int ncompid = 30;
        ...
        private void getEntityCode()
        {
            ...
            rprt.Load(Server.MapPath("~/MemberReport.rpt"));
            rprt.FileName = Server.MapPath("~/MemberReport.rpt");
            SqlCommand cmd = new SqlCommand();
            cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "MemberReport";
            ...
            cmd.Parameters.Add(new System.Data.SqlClient.SqlParameter("@bnature", DropDownList1.SelectedValue));
            cmd.Parameters.Add(new System.Data.SqlClient.SqlParameter("@membership", DropDownList2.SelectedValue));
            cmd.Connection = con;
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            StatementDataSet ds = new StatementDataSet();
            sda.Fill(ds, "MemberReport");
