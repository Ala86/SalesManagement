<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierReport.aspx.cs" Inherits="NACCUGSoft_Online.SupplierReport" %>
...
<%--                <li><a href="InvoiceForm.aspx">Home</a> </li>
    ...
    <form id="form1" runat="server">
     <asp:Panel ID="pnlPopup" runat="server" align="center" Width="60%" Height="40%" BackColor="#CCFFFF" BorderColor="#333300" BorderStyle="Groove" CssClass="active right">
        ...
        <h2 class="auto-style2"><strong>Supplier Report</strong></h2>
        <div id="container">
