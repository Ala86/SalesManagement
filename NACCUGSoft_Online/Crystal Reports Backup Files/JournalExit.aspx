<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="JournalExit.aspx.cs" Inherits="NACCUGSoft_Online.JournalExit" %>
...
<%--                <li><a href="InvoiceForm.aspx">Home</a> </li>
    ...
    <form id="form1" runat="server">
          <h2>Trial Balance</h2>
        <p>
            <asp:TextBox ID="TextBox3" type="date" runat="server" Width="200px" Height="40" Text="Select Date"></asp:TextBox>
            <asp:Button ID="Button1" onClick="Button1_Click" runat="server" Width="200px" Height="40" BackColor="Blue" ForeColor="White" Text="Filter by Date" />
            <asp:Button ID="Button2" onClick="Button2_Click" runat="server" Width="200px" Height="40" BackColor="Blue" ForeColor="White" Text="Export to Excel" />
   </p>
            <p>
                    <asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Width="1500px" Height="40px" >
